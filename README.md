...
Assessment will be 100% by coursework/quiz. It is open book but absoluetly forbids use of any AI tools or internet resources, aside from the links provided in the notes, including translation softwares other than plain dictionaries and Google translate (Text only) accessed via https://translate.google.com/. You cannot use an AI models trained on the notes during the quiz, but you can use a search function to find keywords. 
